CREATE OR REPLACE PACKAGE  stpks_stddori1_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stddori1_main.spc
  **
...
TYPE ty_stddori1 IS RECORD (
     v_sttms_dowi_group_fcust     sttm_dowi_group_fcust%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stddori1_main FOR stpks_stddori1_main
/